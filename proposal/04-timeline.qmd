...
Preliminary release and initial CRAN submission  | Two months     | Comprehensive pkgdown documentation, website hosting, initial submission of version 1.0.0 to CRAN, and host a community webinar.
...
Inception and take-off (USD1500): Funds 30 hours of core development work at a rate of USD50/hour. This covers GitHub setup and integration with local machine codes and designing the user-facing API wrappers

Coding and testing (USD5000): Funds 100 hours of setting up functions and algorithms, testing them for consistency and reproducibility and integrating with GitHub repositories. Setting up documentation and website. Initial submission to CRAN.
